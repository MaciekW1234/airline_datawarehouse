...
| Metryka | Wartość |
|---|---|
| Łączna liczba wierszy w Fact_Flights | 6 410 315 |
...
### 3.1 Fact_Flights (6 410 315 wierszy)
...
1. **FAA — uzupełnienie słownika lotnisk:** 52k incydentów (15,2%) bez dopasowania do Dim_Airport. Rekomendowane uzupełnienie OpenFlights o lotniska wojskowe i prywatne z bazy FAA.
2. **FAA — jakość pola SIZE i NR_FATALITIES:** Dane te zawierają ewidentne błędy wprowadzenia do systemu FAA. Rekomendowane zgłoszenie do FAA lub filtrowanie na poziomie BronzeToSilver.
3. **Monitoring ETL_Errors:** Zalecane regularne przeglądanie tabeli `silver.ETL_Errors` po każdym załadowaniu - szczególnie wzrost liczby błędów MISSING_DIMENSION może sygnalizować zmiany w kodach lotnisk lub przewoźników.
